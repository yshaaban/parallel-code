export enum IPC {
  ...
  SendTaskPromptInput = 'send_task_prompt_input',
  ExecuteAgentSessionOperation = 'execute_agent_session_operation',
  GetAgentSessionOperationProjection = 'get_agent_session_operation_projection',
  GetTaskReliabilityCapabilities = 'get_task_reliability_capabilities',
  GetInitialPromptDeliveryProjection = 'get_initial_prompt_delivery_projection',
  ResolveInitialPromptAmbiguity = 'resolve_initial_prompt_ambiguity',
  ReviseInitialPromptDraft = 'revise_initial_prompt_draft',
  SendInitialPromptManually = 'send_initial_prompt_manually',
  TaskReliabilityChanged = 'task_reliability_changed',
  ...
  ListTaskCreationReconciliations = 'list_task_creation_reconciliations',
  ...
  IssueTaskMergeOperation = 'issue_task_merge_operation',
  StartTaskMergeOperation = 'start_task_merge_operation',
  GetTaskMergeOperationStatus = 'get_task_merge_operation_status',
  GetTaskNotesCapability = 'get_task_notes_capability',
  GetTaskNotes = 'get_task_notes',
  IssueTaskNotesOperation = 'issue_task_notes_operation',
  UpdateTaskNotes = 'update_task_notes',
  ...
  ContainersDestroyTask = 'containers_destroy_task',
  ContainersGetTaskLogs = 'containers_get_task_logs',
  GetServerStateBootstrap = 'get_server_state_bootstrap',
  CoordinatorActivityHint = 'coordinator_activity_hint',
  CoordinatorChanged = 'coordinator_changed',
  ...
  WindowCloseHandled = '__window_close_handled',
  ...
  TaskNotesChanged = 'task_notes_changed',
