...
- [docs/PRODUCT-VALIDATION-OBJECTIVES.md](docs/PRODUCT-VALIDATION-OBJECTIVES.md) for user-frustration goals and proof direction
...
- [PRODUCT.md](PRODUCT.md) for product context only
...
- product validation objectives define user pain and proof intent
