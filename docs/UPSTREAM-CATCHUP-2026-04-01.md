...
| `9ce6abe` | partial | `reimplement on our architecture` | `workflow / app`      | `runtime / integration` | The shared app-level markdown viewer and owned `.md` routing from task-note/file surfaces are landed locally; terminal-owned `.md` routing remains the follow-up gap. |
...
| `a37b958` | partial | `reimplement on our architecture` | `workflow / app`      | `runtime / integration` | Same bounded `.md` viewer family as `9ce6abe`: local note/file surfaces now open in the shared viewer, while terminal-owned routing remains deferred.               |
...
4. Phase 4 is now landed locally:
   ...
   - `fb86cc5`
   - bounded subset of `b944064`
5. Treat the remaining markdown/viewer queue as bounded follow-up work:
   - terminal-owned `.md` routing: `9ce6abe`, `a37b958`
   - Mermaid in the owned viewer path: `e56a9fc`
