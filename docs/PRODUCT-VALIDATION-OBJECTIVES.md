...
| --------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Review discipline                 | `npm run validate:pr-description` and `npm run test:validation-guards`                                                                                                                                                     | Pair with `npm run check` before review when code changed.                                                                                                    |
...
| Preview and port exposure         | `npm run test:node:file -- server/browser-preview.test.ts electron/ipc/task-ports.test.ts src/app/task-ports.test.ts`                                                                                                      | Add `npm run test:solid:file -- src/components/PreviewPanel.test.tsx` or targeted browser proof when real navigation, cookies, redirects, or iframes changed. |
