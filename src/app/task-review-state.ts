...
export function getTaskReviewHighestAppliedVersion(): number {
  return taskReviewVersionTracker.highestVersion;
}
...
export function resetTaskReviewVersionTracking(): void {
